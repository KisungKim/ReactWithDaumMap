...
import GetUserInputMessage from "./DaumMapComponent_getUserInputMessage.js";

class GetUserInputAddress extends Component {
    ...
    confirmAddress = () => {
        ...
        document.getElementById('startAddMode').innerHTML = "원하는 메시지를 적어주세요";
        document.getElementById('confirmAddress').hidden = true;
    }

    // DaumMapComponent_getUserInputMessage.js에서 사용(해당 마커에 인포윈도우 설정)
    ...
    addStart = () => {
        ...
        document.getElementById('startAddMode').innerHTML = "원하는 지역을 지도에서 클릭하세요";
...
export default GetUserInputAddress;
